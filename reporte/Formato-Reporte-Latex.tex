...
{
\fancyhf{}
\rhead{\includegraphics[width=3.25cm]{udec.png}}
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\footrulewidth}{0pt}
\lhead{\small{
\textbf{Nombre} \\
\textbf{Asignatura / Proyecto / Etc.} \\}}
\cfoot{ \small{\textbf{\thepage}}}
}
\setlength{\headheight}{30pt} %%%%
\pagestyle{firststyle}
\title {\vspace{-5mm} \textbf{Formato en \LaTeX{} para Reportes} \vspace{-10mm}}
\date{}
...
\begin{table}[h]
	...
	\begin{tabular}{cccc}
		...
		\midrule
		Input & - & - & 128x128 \\
		Convolution & 5x5 & 64 & 124x124 \\
		Pooling & 2x2 & 64 & 62x62 \\
